...
function FeatureCard({
  ...
  return (
    ...
    >
      ...
      <h3 className="mt-6 text-2xl font-bold text-white drop-shadow-lg">
        {title}
      </h3>
      <p className="mt-3 text-lg text-gray-200 leading-relaxed drop-shadow-md">
        {desc}
      </p>
    </div>
  );
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-black">
            ...
            <div className="grid items-center gap-16 lg:grid-cols-2">
              ...
              <div className="space-y-8 z-20 animate-[fadeInUp_0.8s_ease-out]">
                ...
                <h1 className="text-5xl lg:text-7xl font-black tracking-tight leading-[1.1] animate-[fadeInUp_0.8s_ease-out_0.3s_both]">
                  <span className="block pb-2 text-white drop-shadow-[0_4px_12px_rgba(0,0,0,0.8)]">
                    Discover your
                  </span>
                  <span
                    className="block bg-gradient-to-r from-cyan-300 via-blue-200 to-purple-300 bg-clip-text text-transparent drop-shadow-[0_4px_12px_rgba(0,0,0,0.8)] pb-2"
                  ...
                  <span
                    className="block text-yellow-200 pb-2 drop-shadow-[0_4px_12px_rgba(0,0,0,0.8)]"
                ...
                <div className="flex flex-wrap items-center gap-4 animate-[fadeInUp_0.8s_ease-out_0.7s_both]">
                  ...
                  <button
                    onClick={() => navigate("/ai")}
                    className="inline-flex items-center gap-3 rounded-2xl bg-gradient-to-r from-purple-500 to-pink-600 px-8 py-4 text-lg font-bold text-white shadow-2xl shadow-purple-500/50 transition-all hover:scale-105 hover:shadow-pink-500/60 hover:-translate-y-1 focus:outline-none focus:ring-4 focus:ring-pink-400/50 active:scale-95 drop-shadow-xl"
                  >
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6">
            <div className="text-center mb-16 animate-[fadeInUp_0.8s_ease-out]">
              <h2 className="text-4xl lg:text-5xl font-bold text-white mb-4 pb-2 drop-shadow-xl">
                ...
                <span
                  className="block bg-gradient-to-r from-cyan-300 to-blue-300 bg-clip-text text-transparent pb-2 drop-shadow-xl"
      ...
      <style>{`
        ...
        @keyframes streamRotate { from { opacity: 0; transform: translateY(20px) scale(0.9); } to { opacity: 1; transform: translateY(0) scale(1); } }
        @keyframes glow { 0%, 100% { box-shadow: 0 0 20px rgba(251, 191, 36, 0.4); } 50% { box-shadow: 0 0 30px rgba(251, 191, 36, 0.6), 0 0 40px rgba(251, 191, 36, 0.4); } }
      `}</style>
    </div>
  );
};
