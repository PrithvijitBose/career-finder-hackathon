              ...
              >
                ...
                <ScrollReveal>
                  <p className="max-w-xl text-lg text-muted-foreground">
                    Take our free aptitude quiz to get tailored stream
                    suggestions, explore courses, and discover top colleges
                    across districts.
                  </p>
                </ScrollReveal>
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="inline-flex rounded-lg bg-indigo-50 p-3 text-indigo-700 transition group-hover:bg-indigo-100 dark:bg-indigo-500/15 dark:text-indigo-300"
      >
        {icon}
      </motion.div>
